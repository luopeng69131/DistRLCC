...
def get_args_new(isTrain):
    parser = argparse.ArgumentParser(description='RL')
    get_com_args(parser)
    if isTrain:
        args = get_train_args(parser)
    else:
        args = get_test_args(parser)
    return args

def get_com_args(parser):
    parser.add_argument(
        '--num-processes',
        type=int,
        default=8,
    ...
    parser.add_argument(
        ...
        type=int,
        default=9,
        help='number of resnet blocks (default: 9)')
#------------not use--------------------
    parser.add_argument(
        '--recurrent-policy',
        action='store_true',
...
def get_train_args(parser):
    ...
    parser.add_argument(
        '--transfer-dir',
        default='./trained_models/transfer_weight/weight.model',
        help='directory to save agent logs (default: ./transfer_weight/)')
    parser.add_argument(
        '--excel-save',
        action='store_true',
        default=False,
